...
public class ConditionNormalizedClosenessIT extends AbstractPrologITC {
  ...
  protected String getWheneverCode() {
    ...
    return "get_app_users_except_me(Users) and get_profile_id(UserId)";
  }
  ...
  protected String getThenceforthCode() {
    ...
    return "normalized_closeness(Result,UserId,Users,10000) and send_user_message(\"result\",json([closeness=Result]))";
  }
